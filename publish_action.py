...
PATH = '/home/vail/aj_ws/src/jackal/models/boxes__1800%40_ResNet50_lr_0.0015_wd_0.0015_loss_0.6600037713845571.pt'
        ...
        while not rospy.is_shutdown():
            ...
            if len(self.tensor_x_z_actions) == 0:
                ...
                if len(self.tensor_x_z_actions) >= tmp:  # publish actions only when action is sent from neural network output
                    ...
                    x = move.linear.x = self.tensor_x_z_actions[i][0][0]/32
                    #z = move.angular.z = self.tensor_x_z_actions[i][0][1]/64
                    print(x)
